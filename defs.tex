...
\newcommand{\yt}{\ensuremath{\boldsymbol{y}^\text{true}}\xspace}
\newcommand{\yp}{\ensuremath{\boldsymbol{y}^\text{pred}}\xspace}

%%%%%%%%Theory%%%%%%%%
\newcommand{\Lagr}{\mathcal{L}}
\newcommand{\AH}{\ensuremath{A/H}\xspace}
\newcommand{\suthr}{\ensuremath{\text{SU(3)}_C}\xspace}
\newcommand{\sutwo}{\ensuremath{\text{SU(2)}_L}\xspace}
\newcommand{\uone}{\ensuremath{\text{U(1)}_Y}\xspace}
