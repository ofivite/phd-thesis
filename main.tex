...
% change font in math equations
\usepackage{newtxtext,newtxmath}

% set mathcal to old caligraphy 
% \DeclareSymbolFont{eulerletters}{U}{zeur}{b}{n}
% \DeclareMathSymbol{\eull}{\mathord}{eulerletters}{L}
% \usepackage{euler}
...
% to correctly read extensions in \includegraphics
\usepackage{graphicx}
\usepackage{grffile}
...
\pagestyle{fancy}
 ...
 \input{include/SM.tex}
 \input{include/CMS.tex}
 \input{include/Tau.tex}
 \input{include/CP_etau.tex}
 \input{include/CP_comb.tex}
 \input{include/outro.tex}
